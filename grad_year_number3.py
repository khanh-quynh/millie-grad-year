...
df = pd.read_csv("grad_number3.csv")
#print(df)
...
grad_year = []
for i in df["Grad_Year"]:
    grad_year.append(int(i))
df["Grad_Year"] = grad_year
...
df_pattern = pd.read_csv("number3_pattern.csv")
